...
<body>
    ...
    <div class="pageContent">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td>
                    <?php $steps = Workflow::getOriginatingStepsForTransition($workflow['id'], $workflowData['transition_name']); ?>
                    <?php if ($steps): ?>
                        <table>
                ...
                <td valign="top">
                    <?php $steps = Workflow::getDestinationStepsForTransition($workflow['id'], $workflowData['transition_name']); ?>
                    <?php if ($steps): ?>
                        <table>
                            <?php while ($step = $steps->fetch_array(MYSQLI_ASSOC)): ?>
                                <tr>
