<div class="infoBox">NOTE: When a new project is created, it will be assigned these 'default members' for the 'Administrators' project role.
...
<table align="center">
    <tr>
        ...
        <td></td>
        <td>Permission role default users</td>
    </tr>
    <tr>
        <td>
