...
<table class="modal-table">
    ...
    <tr>
        ...
        <td>
            ...
            <input disabled="disabled" type="text" value="" style="width: 80px" id="log_remaining_work_set_to" /> (eg. 3w 4d 12h)
            <?php if ($mode == 'new'): ?>
                <br />
                ...
                <input disabled="disabled" type="text" value="" style="width: 80px" id="log_work_remaining_reduce_by" /> (eg. 3w 4d 12h)
            <?php elseif ($mode == 'delete'): ?>
                ...
                <input disabled="disabled" type="text" value="" style="width: 80px" id="log_work_remaining_increase_by" /> (eg. 3w 4d 12h)
            <?php endif ?>
        </td>
    </tr>
    <?php if ($mode != 'delete'): ?>
