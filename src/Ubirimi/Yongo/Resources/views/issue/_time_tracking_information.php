<?php
    ...
    $worklogs = IssueWorkLog::getWorkLogByIssueId($issue['id']);
    $minutesLogged = 0;
...
<table width="100%" id="contentTimeTracking">
    <tr>
        ...
        <td width="100px" align="right"><?php echo Util::transformTimeToString(Util::transformLogTimeToMinutes($issue['original_estimate'], $hoursPerDay, $daysPerWeek), $hoursPerDay, $daysPerWeek, 'short'); ?></td>
        <td valign="middle">
