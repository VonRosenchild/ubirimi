...
<table cellspacing="0" cellpadding="0" border="0" class="tableMenu" width="100%">
    ...
    <tr>
        <td>
            <div><a class="linkSubMenu" href="#" id="issue_submenu_edit_<?php echo $issueId ?>">Edit</a></div>
        </td>
    </tr>
    <tr>
        <td>
            <div><a class="linkSubMenu" href="#" id="issue_submenu_duplicate_<?php echo $issueId ?>">Duplicate</a></div>
        </td>
    </tr>
</table>