...
if (isset($parseURLData['query'])) {
    if (Util::searchQueryNotEmpty($getSearchParameters)) {
        ...
        $issues = UbirimiContainer::getRepository('yongo.issue.issue')->getByParameters($getSearchParameters, $loggedInUserId);
...
require_once __DIR__ . '/../../Resources/views/issue/search/SearchListPrintableContent.php';