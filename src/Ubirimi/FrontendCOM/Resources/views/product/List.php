...
<div class="home-products" style="width: 1420px">
    <ul class="product-list clearfix">
        <li class="product yongo" itemscope itemtype="http://schema.org/IndividualProduct">
            ...
            <a itemprop="url" href="https://www.ubirimi.com/product/yongo" class="button_hp gray" data-slide="0">Learn
                more</a>
        </li>
        <li class="product agile" itemscope itemtype="http://schema.org/IndividualProduct">
            <h3 itemprop="name">Agile</h3>

            <p itemprop="description">Unlocking the power of Agile: planning, estimating and visualizing team
                activity.</p>
            <a itemprop="url" href="https://www.ubirimi.com/product/agile" class="button_hp gray" data-slide="1">Learn
                more</a>
        </li>
        ...
        <li class="product helpdesk" itemscope itemtype="http://schema.org/IndividualProduct">
            ...
            <p itemprop="description">Powerfull helpdesk solution for any organization. Be in touch with your customers.</p>
        ...
        <li class="product documentador" itemscope itemtype="http://schema.org/IndividualProduct" style="margin-top: 20px;">
            ...
            <a itemprop="url" href="https://www.ubirimi.com/product/documentador" class="button_hp gray" data-slide="2">Learn
                more</a>
        </li>
        <li class="product svn" itemscope itemtype="http://schema.org/IndividualProduct" style="margin-top: 20px;">
            ...
            <a itemprop="url" href="https://www.ubirimi.com/product/svn-hosting" class="button_hp gray" data-slide="3">Learn
                more</a>
        </li>
        ...
        <li class="product events" itemscope itemtype="http://schema.org/IndividualProduct" style="margin-top: 20px;">
            ...
            <p itemprop="description">Plan and keep track of people, projects and events. A complete calendar
                application.</p>
            <a itemprop="url" href="https://www.ubirimi.com/product/events" class="button_hp gray" data-slide="3">Learn
                more</a>
        </li>
    </ul>
</div>