    ...
    <div class="pageContent">
        ...
        <form name="add_page" action="/documentador/page/edit/<?php echo $entityId ?>" method="post">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                    <td>
                        <input style="margin: 0px; padding: 4px; height: 30px; font: 22px Trebuchet MS, sans-serif;" id="doc_page_edit_page" class="inputText" style="width: 650px; height: 30px" type="text" value="<?php echo $name; ?>" name="name" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td align="left">
                        <div align="left">
                            <button type="submit" name="edit_page" class="btn ubirimi-btn"><i class="icon-edit"></i> Update Page</button>
